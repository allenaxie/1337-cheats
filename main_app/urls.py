...
urlpatterns = [
    ...
    path('cheatsheets/create/', views.CheatsheetCreate.as_view(), name='cheatsheets_create'),
    path('cheatsheets/<int:cheatsheet_id>/',views.cheatsheets_detail, name='cheatsheets_detail'),
